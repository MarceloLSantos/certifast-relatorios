...
@st.cache_data
def load_data():
    tabela_parceiros = pd.read_excel('dados/Parceiros.xlsx', engine='openpyxl', sheet_name='Parceiros', decimal=',', usecols=['Nome Vendedor','Desc. Agente Val.','COMISSAO','% Venda','% Software','% Hardware','E-MAIL'])
